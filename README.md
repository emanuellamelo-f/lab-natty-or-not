...
1.  **Ideação:** Definição do cenário (árvore/chalé + castelo).
2.  **Engenharia de Prompt:** O prompt foi estruturado para focar na mistura de cores específica (Vermelho, Azul, Dourado, Branco, Preto) e texturas ("folhas únicas"), garantindo que a IA não criasse algo genérico, mas sim fiel à identidade visual do "livro" base.
...
## 💭 Reflexão (Opcional)
O desafio de criar algo 'natty' com IA neste projeto foi equilibrar a quantidade de cores solicitada sem que a imagem ficasse caótica. A IA tendeu a saturar muito as cores inicialmente, exigindo ajustes no prompt para manter a harmonia "natural" da cena, mesmo sendo um cenário de fantasia.
